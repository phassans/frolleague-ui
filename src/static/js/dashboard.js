...
function getData(step) {
  ...
  if (step == 1) {} else if (step == 2) {} else if (step == 3) {} else if (step == 4) {
    getWork();
  } else if (step == 5) {
    getEducation();
  } else if (step == 6) {
